...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ListView ID="SupplierListView" runat="server" DataSourceID="SupplierDataSource" InsertItemPosition="FirstItem" ItemType="WestWindSystem.Entities.Supplier" DataKeyNames="SupplierID">
    ...
    <asp:ObjectDataSource ID="SupplierDataSource" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ListSuppliers" TypeName="WestWindSystem.BLL.CRUDController" DataObjectTypeName="WestWindSystem.Entities.Supplier" InsertMethod="AddSupplier"
        ...
        OnDeleted="CheckForException" UpdateMethod="UpdateSupplier" DeleteMethod="DeleteSupplier"></asp:ObjectDataSource>
